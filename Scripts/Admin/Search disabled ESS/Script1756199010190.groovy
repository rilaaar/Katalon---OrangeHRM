...
WebUI.verifyElementVisible(findTestObject('Admin Page/verify_list_ESS_roleUser'), FailureHandling.OPTIONAL)

WebUI.verifyElementVisible(findTestObject('Admin Page/verify_list_enabled_status_role'), FailureHandling.OPTIONAL)
