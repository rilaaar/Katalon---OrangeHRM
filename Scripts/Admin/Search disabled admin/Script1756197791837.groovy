...
WebUI.click(findTestObject('Admin Page/Search data/admin_role_option', [('optionName') : 'Admin']))

WebUI.click(findTestObject('Admin Page/Search data/button_select_status'))

WebUI.click(findTestObject('Admin Page/Search data/disabled_status', [('optionName') : 'Disabled']))

WebUI.click(findTestObject('Admin Page/Search data/button_search'))

WebUI.verifyElementVisible(findTestObject('Admin Page/Search data/verify_list_admin_roleUser'))

WebUI.verifyElementVisible(findTestObject('Admin Page/Search data/verify_list_disabled_status_role'))
